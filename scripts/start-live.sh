...
# reconciled probe cycles, a recent backup, a clean test/security run) and
# refuses to sign a single live transaction unless every one of those is
# actually true — this script cannot bypass that, and does not try to.
#
